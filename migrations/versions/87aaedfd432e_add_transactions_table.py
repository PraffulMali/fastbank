...
def upgrade() -> None:
    ...
    sa.Column('transaction_type', sa.Enum('DEBIT', 'CREDIT', name='transaction_type_enum', create_constraint=True), nullable=False),
    sa.Column('reference_type', sa.Enum('TRANSFER', 'LOAN', 'SYSTEM', name='reference_type_enum', create_constraint=True), nullable=False),
    sa.Column('amount', sa.Numeric(precision=15, scale=2), nullable=False),
    sa.Column('status', sa.Enum('PENDING', 'SUCCESS', 'FAILED', name='transaction_status_enum', create_constraint=True), nullable=False),
